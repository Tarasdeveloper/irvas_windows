  ...
  form.forEach(item => {
    item.addEventListener('submit', e => {
      ...
      postData('assets/server.php', formData).then(res => {
        /* eslint-disable */console.log(...oo_oo(`1047869502_39_10_39_26_4`, res));
